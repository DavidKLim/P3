run_mice = function(dir_name, sim.params, miss.params, X, Y, mask_x, mask_y, g, data_types_x, family, niws = 500){
  library(ggplot2)
  library(grid)
  library(gridExtra)
  library(gtable)
  ...
  N=nrow(X); P=ncol(X)
  # data_types_x=sim.params$data_types_x; family=sim.params$family
